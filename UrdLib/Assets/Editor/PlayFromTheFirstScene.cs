...
namespace Urd.Editor
{
    public static class PlayFromTheFirstScene
    {
        ...
        // The menu won't be gray out, we use t$$anonymous$$s validate method for update check state
        ...
        // T$$anonymous$$s method is called before any Awake. It's the perfect callback for t$$anonymous$$s feature
