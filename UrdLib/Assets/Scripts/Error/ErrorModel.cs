...
namespace Urd.Error
{
    public class ErrorModel
    {
        ...
        public static ErrorModel Success => new ErrorModel();

        public  IErrorNetworkModel ErrorNetworkModel { get; private set; }
        ...
        public void SetNetworkModel(IErrorNetworkModel networkModel)
        {
            ErrorNetworkModel = networkModel;
        }
        
        public override string ToString()
        {
            return $"Error: {Message}. ErrorCode: {ErrorCode}. ErrorNetwork:{ErrorNetworkModel}";
        }
    }
}